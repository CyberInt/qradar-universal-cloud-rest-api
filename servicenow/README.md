...
| `events_per_fetch`                | Events Per Fetch                         | False                 | Number          | Max number of records to return per fetch. To avoid events duplication set this value to a maximun '10000'.               | `10000`         |
